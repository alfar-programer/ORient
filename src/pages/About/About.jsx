...
const About = () => {
  return (  
    ...
    <div className="main-aboutus bg-gradient-to-br">
      <div className="container">
        <div className="min-container text-center text-white">
          <h1 className="text-titleabout text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 ">
            من نحن
          </h1>
          <div className="minmin-container grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-right order-2 md:order-1">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6">ORIENT</h2>
              ...
              <button className="btn-contact mt-6 sm:mt-8">
              <a href="/Projects" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300"> تواصل معنا </a>
            </button>
            </div>
            <div className="text-center order-1 md:order-2">
              <div className="bg-gradient-to-br from-blue-500 to-text-gray-300 rounded-full w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 mx-auto flex items-center justify-center">
