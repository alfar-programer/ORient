...
const About = () => {
  return (  
    ...
    <div className="main-aboutus bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 py-20">
      <div className="container">
        <div className="min-container text-center text-white">
          <h1 className="text-titleabout text-5xl font-bold mb-8 bg-gradient-to-r from-blue-400 to-white bg-clip-text text-transparent">
            من نحن
          </h1>
          <div className="minmin-container grid md:grid-cols-2 gap-12 items-center">
            <div className="text-right">
              <h2 className="text-3xl font-semibold mb-6 text-blue-300">ORIENT</h2>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-full w-64 h-64 mx-auto flex items-center justify-center">
                <span className="text-6xl font-bold text-white"><img src="/images/Logo.png" alt="" /></span>
              </div>
            </div>
          </div>
        </div>
